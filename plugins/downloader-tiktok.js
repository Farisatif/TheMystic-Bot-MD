...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: 'ᴛʜᴇ ᴍʏsᴛɪᴄ - ʙᴏᴛ', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/Farisatif/TheMystic-Bot-MD'}, mentionedJid: [m.sender]}}}, aa);
...
handler.command = /^(tiktok|ttdl|tiktokdl|tiktoknowm|tt|تيك|ttnowm|tiktokaudio)$/i;
