...
export async function before(m, {conn, participants}) {
  ...
  const pp = await conn.profilePictureUrl(m.chat, 'image').catch((_) => null) || 'https://raw.githubusercontent.com/Farisatif/TheMystic-Bot-MD/master/src/avatar_contact.png';
