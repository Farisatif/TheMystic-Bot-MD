...
const handler = async (m, {conn, usedPrefix}) => {
  ...
  const res = await fetchJson(`https://raw.githubusercontent.com/Farisatif/TheMystic-Bot-MD/master/src/JSON/tebaklagu.json`);
...
handler.tags = ['game'];
handler.command = /^cancion|خمن|canción$/i;
