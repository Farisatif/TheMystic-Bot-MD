...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} Zeref
  ${tradutor.texto1[2]} +967778088098
  ...
  const Message = {
    document: { url: `https://github.com/Farisatif/TheMystic-Bot-MD` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://github.com/Farisatif/TheMystic-Bot-MD",
        mediaType: 2,
        previewType: "pdf",
        title: "The Mystic - Bot",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://github.com/Farisatif/TheMystic-Bot-MD",
      },
    },
    caption: info,
    footer: wm,
