...
const handler = async (m, { command, usedPrefix, conn, text }) => {
  ...
  try {
    apiUrlsz = [
      ...
      `https://api-brunosobrino.onrender.com/api/ytplay?text=${text}&apikey=Farisatif`,
    ...
    if (linkyt) apiUrlsz = [
        ...
        `https://api-brunosobrino-koiy.onrender.com/api/ytinfo?url=${text}&apikey=Farisatif`,
    ...
    try {
      if (command === 'play.1') {
        let apiUrls2 = [
          ...
          `https://api-brunosobrino.onrender.com/api/v1/ytmp3?url=${data.resultado.url}&apikey=Farisatif`,
          `https://api-brunosobrino.onrender.com/api/v2/ytmp3?url=${data.resultado.url}&apikey=Farisatif`,
        ...
        let apiUrls22 = [
          ...
          `https://api-brunosobrino.onrender.com/api/v1/ytmp4?url=${data.resultado.url}&apikey=Farisatif`,
          `https://api-brunosobrino.onrender.com/api/v2/ytmp4?url=${data.resultado.url}&apikey=Farisatif`,
